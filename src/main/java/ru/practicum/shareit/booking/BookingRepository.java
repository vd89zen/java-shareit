...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query("SELECT b FROM Booking b " +
            ...
            "ORDER BY b.start DESC")
    List<Booking> findByBookerIdPastBookings(@Param("bookerId") Long bookerId, @Param("statuses") List<Status> statuses);
    ...
    @Query("SELECT b FROM Booking b " +
            ...
            "AND b.status IN :statuses " +
            "ORDER BY b.start DESC")
    List<Booking> findByBookerIdFutureBookings(@Param("bookerId") Long bookerId, @Param("statuses") List<Status> statuses);
    ...
    @Query("SELECT b FROM Booking b " +
            ...
            "AND b.status = :status " +
            "ORDER BY b.start DESC")
    List<Booking> findByBookerIdCurrentBookings(@Param("bookerId") Long bookerId, @Param("status") Status status);
    ...
    @Query("SELECT b FROM Booking b " +
            ...
            "AND b.status IN :statuses " +
            "ORDER BY b.start DESC")
    List<Booking> findByOwnerIdPastBookings(@Param("ownerId") Long ownerId, @Param("statuses") List<Status> statuses);
    ...
    @Query("SELECT b FROM Booking b " +
            ...
            "AND b.status IN :statuses " +
            "ORDER BY b.start DESC")
    List<Booking> findByOwnerIdFutureBookings(@Param("ownerId") Long ownerId, @Param("statuses") List<Status> statuses);
    ...
    @Query("SELECT b FROM Booking b " +
            ...
            "AND b.status = :status " +
            "ORDER BY b.start DESC")
    List<Booking> findByOwnerIdCurrentBookings(@Param("ownerId") Long ownerId, @Param("status") Status status);
    ...
    @Query("SELECT NEW ru.practicum.shareit.item.dto.ItemBookingDatesDto(" +
            "b.item.id, " +
